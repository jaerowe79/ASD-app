...
var json = {
	"event1": {
		"toe": ["Type of Event: ", "Family"],
    	"name": ["Event Name: ", "Zach's Birthday"],
    	"date": ["Event Date: ", "07/06/2012"],
    	"time": ["Event Time: ", "1:00 pm" ],
    	"loi": ["Importance of Event: ", "10"],
    	"notes": ["Notes: ", "Don't forget balloons!"]
    },
    "event2": {
    	"toe": ["Type of Event: ", "Other"],
    	"name": ["Event Name: ", "Office Party"],
    	"date": ["Event Date: ", "01/31/2012"],
    	"time": ["Event Time: ", "4:00 pm" ],
    	"loi": ["Importance of Event: ", "6"],
    	"notes": ["Notes: ", "Don't forget drinks"]
    },
    "event3": {
    	"toe": ["Type of Event: ", "Friend"],
    	"name": ["Event Name: ", "Dinner Party"],
    	"date": ["Event Date: ", "08/10/2012"],
    	"time": ["Event Time: ", "10:00 pm" ],
    	"loi": ["Importance of Event: ", "10"],
    	"notes": ["Notes: ", "Formal Attire"]
    },
    "event4": {
    	"toe": ["Type of Event: ", "Friend"],
    	"name": ["Event Name: ", "Daniel's Birthday Party"],
    	"date": ["Event Date: ", "11/11/2012"],
    	"time": ["Event Time: ", "5:30 pm" ],
    	"loi": ["Importance of Event: ", "10"],
    	"notes": ["Notes: ", "Bring a gift!"]
    },
    "event5": {
    	"toe": ["Type of Event: ", "Family"],
    	"name": ["Event Name: ", "School Party"],
    	"date": ["Event Date: ", "04/14/2012"],
    	"time": ["Event Time: ", "10:00 am" ],
    	"loi": ["Importance of Event: ", "10"],
    	"notes": ["Notes: ", "Bring gift bags."]
    },
    "event6": {
    	"toe": ["Type of Event: ", "Other"],
    	"name": ["Event Name: ", "Class"],
    	"date": ["Event Date: ", "04/06/2012"],
    	"time": ["Event Time: ", "7:00 pm" ],
    	"loi": ["Importance of Event: ", "8"],
    	"notes": ["Notes: ", "None"]
    },
    "event7": {
    	"toe": ["Type of Event: ", "Other"],
    	"name": ["Event Name: ", "Date Night"],
    	"date": ["Event Date: ", "03/26/2012"],
    	"time": ["Event Time: ", "10:30 pm" ],
    	"loi": ["Importance of Event: ", "10"],
    	"notes": ["Notes: ", "Wear a dress"]
    },
    "event8": {
    	"toe": ["Type of Event: ", "Family"],
    	"name": ["Event Name: ", "Parent's Anniversary Party"],
    	"date": ["Event Date: ", "02/27/2012"],
